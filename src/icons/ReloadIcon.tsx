...
const ReloadIcon: FC<Props> = ({ size = DEFAULT_SIZE }) => (
  <svg width={size} height={size} viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <path d='M11 9L13 8.5L13.5 10.5' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' />
    <path
    ...
    />
    <path d='M3 5L1 5.5L0.5 3.5' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' />
    <path
