...
const FeedSection: FC<Props> = ({ title }) => {
  ...
  const renderedItem = (
    <div className='bg-white hover:bg-gray-100/40 dark:bg-slate-900 dark:hover:bg-slate-800/40 ring-gray-200 dark:ring-slate-800 ring-1 rounded-lg p-6 pb-4 w-30 cursor-pointer'>
      <p className='font-bold h-10 text-sm mb-4 text-gray-900 dark:text-slate-200 text-ellipsis overflow-hidden'>
  ...
  return (
    <div className='w-fill mb-8'>
      <h4 className='text-xl font-bold dark:text-slate-300 mb-4'>{title}</h4>
